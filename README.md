...
- ``Technique Report`` [SwanTale: Unified Multi-Speaker Speech and Audio Generation for Instruct and Zero-Shot Tasks](https://arxiv.org/abs/2608.02023), **Yu Zhang**, Ruiqi Li, Changhao Pan, et al.
...
- ``EMNLP 2026`` [One-Stage Multi-Task Instruction-Guided 3D Spatial Audio Editing](https://arxiv.org/abs/2609.04975), Ke Lei\*, Chenyuhao Wen\*, **Yu Zhang\***, et al.
